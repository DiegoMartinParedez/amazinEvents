...
////Crear Array de Upcoming events////////////////////////
let upcomingEvents = [];
const baseDate = data.currentDate;

for (let i = 0; i < data.events.length; i++) {
  if (baseDate < data.events[i].date) {
    let obj = {};
...
// //////////Crear cards Upcoming Events////////////////////////
const contenedorCards = document.querySelector('#cards')

let cards = ''

 for (const card of upcomingEvents) {
